...
Процедура УстановитьВидимостьЭлементовФормы()
	...
	Если Объект.КлубПокупатель = ФутбольныйКлубМенеджера Тогда
		...
		ПереговорыЗавершены = Объект.СтатусПереговоров = Перечисления.СтатусПереговоров.Отклонено 
			Или Объект.СтатусПереговоров = Перечисления.СтатусПереговоров.Принято;    
			
		ОжидаетсяДействиеИгрока = Не Объект.ОжидаетсяДействиеИгры И Не ПереговорыЗавершены;
